(() => {
  ...
  const translations = {
    ...
    zh: {
      ...
      scoreboardConnected: "实时排行榜已连接",
      scoreboardOffline: "离线设置模式",
      scoreboardLoading: "正在载入实时成绩……",
      scoreboardNoData: "还没有在线成绩。完成一局游戏后会自动提交成绩。",
      scoreboardNotReady: "请先连接 Firebase，才会显示实时成绩。",
      scoreboardSubmitted: "成绩已提交到实时排行榜。",
